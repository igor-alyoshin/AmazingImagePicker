package com.widget.amazingimagepicker.view.appbarlayout_23_2_1;
...
public class AppBarLayout extends LinearLayout {
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        private void animateOffsetTo(final CoordinatorLayout coordinatorLayout,
            ...
            mAnimator.setDuration(ANIMATE_OFFSET_DIPS_PER_SECOND);
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        private void offsetChildAsNeeded(CoordinatorLayout parent, View child, View dependency) {
            ...
            if (behavior instanceof Behavior) {
                ...
                ablBehavior.setTopAndBottomOffset(dependency.getTop());
                ablBehavior.dispatchOffsetUpdates((AppBarLayout) dependency);
